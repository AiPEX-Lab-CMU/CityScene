namespace GameCreator.Update
{
    ...
    public static class GameCreatorInstall
    {
        ...
        public const string MAGIC_CODE = "EngpA9p9rr8JkWFVH4kM";
        ...
        private const string ERR_OLD = "Your Unity version is older than 2018.4, which is no longer supported.";
        private const string ERR_ALPHA = "Your Unity version is an Alpha version and is highly unstable.";
        private const string ERR_TECH = "Your Unity version is a Tech-Stream version and there might be some incompatibilities.";
        private const string ERR_LTS = "Please, consider using the latest Unity LTS version";
        ...
        public static Requirement MeetsUnityRequirements()
        {
            ...
            success = true;
            message = string.Format("{0} {1}", ERR_TECH, ERR_LTS);
